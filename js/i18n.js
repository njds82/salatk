...
const translations = {
    ar: {
        ...
        nav_customize_title: 'تخصيص قائمة الصفحات',
        nav_customize_subtitle: 'رتّب الصفحات وأظهر أو أخفِ ما تريد في القائمة الرئيسية.',
        nav_customize_required: 'أساسي',
        nav_customize_move_up: 'تحريك لأعلى',
        nav_customize_move_down: 'تحريك لأسفل',
        nav_customize_show: 'إظهار',
        nav_customize_hide: 'إخفاء',
        nav_customize_visible: 'ظاهر',
        nav_customize_hidden: 'مخفي',
        nav_customize_from_more: 'من المزيد',
        nav_customize_reset: 'إعادة تعيين القائمة',
        nav_customize_saved: 'تم حفظ ترتيب القائمة',
        theme: 'المظهر',
        theme_light: 'فاتح',
        theme_dark: 'داكن',
        theme_auto: 'تلقائي',
        ...
        more_empty_customized: 'تم نقل جميع صفحات "المزيد" إلى القائمة الرئيسية.',
    ...
    en: {
        ...
        nav_customize_title: 'Customize Pages List',
        nav_customize_subtitle: 'Reorder pages and show/hide what appears in the main navigation.',
        nav_customize_required: 'Required',
        nav_customize_move_up: 'Move up',
        nav_customize_move_down: 'Move down',
        nav_customize_show: 'Show',
        nav_customize_hide: 'Hide',
        nav_customize_visible: 'Visible',
        nav_customize_hidden: 'Hidden',
        nav_customize_from_more: 'From More',
        nav_customize_reset: 'Reset list',
        nav_customize_saved: 'Pages list updated',
        theme: 'Theme',
        theme_light: 'Light',
        theme_dark: 'Dark',
        theme_auto: 'Auto',
        ...
        more_empty_customized: 'All More pages are already shown in the main menu.',
        copy_success: 'Copied!',
